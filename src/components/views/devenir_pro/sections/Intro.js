          ...
          <Col md={6} lg={5}>
            <div className="DPIntro__box d-flex flex-column h-100 mt-5">
              ...
              <div className="DPIntro_paragraph">
                <p className="DPIntro__text mb-4 pb-xl-4">{t("BecomeProfesional.section_1.paragraph_1")}</p>
                <p className="DPIntro__text mb-4 pb-xl-4">{t("BecomeProfesional.section_1.paragraph_2")}</p>
                <p className="DPIntro__text mb-4 pb-xl-5 mb-xl-5">{t("BecomeProfesional.section_1.paragraph_3")}</p>
              </div>
              <div className="DPIntro__button mt-5 pt-2 mt-md-0 pt-md-0 ">
                <Button variant="outline-secondary" size="lg">{t("BecomeProfesional.section_1.button")}</Button>
              </div>
            </div>
          </Col>
          <Col md={6} lg={6}>
