                        ...
                        <Grid container >
                            <Grid item xs={12} sm={12} md={6}>
                                <Box className={classes.groupLabelInput}>
                                    ...
                                    <Input
                                        id="firstName" 
                                        placeholder={t("ProForm.FormPersonalDetails.firstNameLabel")} 
                                        size="small" 
                                        onBlur={handleChange} 
                                        defaultValue={values.firstName} 
                                        variant="outlined" 
                                        error={(formErrors.step1.firstName.length > 0 && values.validate === 1) ? t("ProForm.validations.firstName") : ""}
                                    />
{/* 
 ...
 */}
                            ...
                            <Grid item xs={12} sm={12} md={6}>
                                <Box className={classes.groupLabelInput}>
                                    ...
                                    <Input
                                        id="lastName" 
                                        placeholder={t("ProForm.FormPersonalDetails.lastNameInput")} 
                                        size="small" 
                                        onBlur={handleChange} 
                                        defaultValue={values.lastName} 
                                        variant="outlined" 
                                        error={(formErrors.step1.lastName.length > 0 && values.validate === 1) ? t("ProForm.validations.lastName") : ""}
                                    />
{/* 
                            ...
                            <Grid container >
                                ...
                                <Grid item xs={12} sm={12} md={6}>
                                    <Box className={classes.groupLabelInputAddress}>
                                        <Input
                                            id="city" 
                                            placeholder={t("ProForm.FormPersonalDetails.address.city")} 
                                            size="small" 
                                            defaultValue={values.city} 
                                            variant="outlined" 
                                            readOnly="true"
                                            error={(formErrors.step1.city.length > 0 && values.validate === 1) ? t("ProForm.validations.city") : ""}
                                        />
{/* 
                                ...
                                <Grid item xs={12} sm={12} md={4}>
                                    <Box className={classes.groupLabelInputAddress}>
                                        <Input
                                            id="province" 
                                            placeholder={t("ProForm.FormPersonalDetails.address.province")} 
                                            size="small" 
                                            defaultValue={values.province} 
                                            variant="outlined" 
                                            readOnly="true"
                                            error={(formErrors.step1.province.length > 0 && values.validate === 1) ? t("ProForm.validations.province") : ""}
                                        />
{/* 
 ...
 */}
                                ...
                                <Grid item xs={12} sm={12} md={4}>
                                    <Box className={classes.groupLabelInputAddress}>
                                        <Input
                                            id="country" 
                                            placeholder={t("ProForm.FormPersonalDetails.address.country")} 
                                            size="small" 
                                            defaultValue={values.country} 
                                            variant="outlined" 
                                            readOnly="true"
                                            error={(formErrors.step1.country.length > 0 && values.validate === 1) ? t("ProForm.validations.country") : ""}
                                        />
{/* 
                                ...
                                <Grid item xs={12} sm={12} md={4}>
                                    <Box className={classes.groupLabelInputAddress}>
                                        <Input
                                            id="postCode" 
                                            placeholder={t("ProForm.FormPersonalDetails.address.postCode")} 
                                            size="small" 
...
{/* 
                        ...
                        <Box className={classes.groupLabelInput}>
                            ...
                            <Input 
                                id="email" 
                                placeholder={t("ProForm.FormPersonalDetails.emaillLabel")} 
                                size="small" 
                                onBlur={handleChange} 
                                defaultValue={values.email} 
                                variant="outlined" 
                                error={(formErrors.step1.email.length > 0 && values.validate === 1) ? t("ProForm.validations.email") : ""}
                            />
{/* 
